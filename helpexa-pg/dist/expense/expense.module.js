...
exports.ExpenseModule = ExpenseModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([expense_item_entity_1.ExpenseItem])],
        providers: [expense_resolver_1.ExpenseResolver, expense_service_1.ExpenseService],
