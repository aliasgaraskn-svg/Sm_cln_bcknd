...
const approvals_resolver_1 = require("./approvals.resolver");
...
exports.ApprovalsModule = ApprovalsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([approval_item_entity_1.ApprovalItem])],
        providers: [approvals_resolver_1.ApprovalsResolver, approvals_service_1.ApprovalsService],
