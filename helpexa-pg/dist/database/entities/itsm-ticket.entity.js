...
exports.ItsmTicket = void 0;
const typeorm_1 = require("typeorm");
const graphql_1 = require("@nestjs/graphql");
const base_entity_1 = require("./base.entity");
const user_entity_1 = require("./user.entity");
let ItsmTicket = class ItsmTicket extends base_entity_1.BaseEntity {
    category;
    priority;
    subject;
    description;
...
__decorate([
    ...
    (0, graphql_1.Field)({ nullable: true }),
    __metadata("design:type", String)
], ItsmTicket.prototype, "openDate", void 0);
__decorate([
    (0, typeorm_1.Column)({ nullable: true }),
    (0, graphql_1.Field)({ nullable: true }),
    __metadata("design:type", String)
], ItsmTicket.prototype, "closeDate", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User),
    (0, graphql_1.Field)(() => user_entity_1.User, { nullable: true }),
    __metadata("design:type", user_entity_1.User)
], ItsmTicket.prototype, "user", void 0);
exports.ItsmTicket = ItsmTicket = __decorate([
    (0, typeorm_1.Entity)('itsm_tickets'),
    (0, graphql_1.ObjectType)()
], ItsmTicket);
//# sourceMappingURL=itsm-ticket.entity.js.map