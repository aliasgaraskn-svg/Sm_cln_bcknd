...
export declare class AgentService {
    ...
    private model;
    private activeChat;
    constructor(configService: ConfigService, hrService: HrService, itsmService: ItsmService, expenseService: ExpenseService, learningService: LearningService);
    processRequest(prompt: string): Promise<AgentResponse>;
